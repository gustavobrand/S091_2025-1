...
class Canvas extends java.awt.Canvas {
    ...
    private void createFrame() {
        ...
        contentPanel.add(new JLabel("Selecione e arraste para mover."), BorderLayout.PAGE_END);
        contentPanel.add(new JLabel("Clique com botão direito para mudar a cor."), BorderLayout.PAGE_END);
        contentPanel.add(new JLabel("Desfazer: Ctrl+Z, Refazer: Ctrl+R"), BorderLayout.PAGE_END);
